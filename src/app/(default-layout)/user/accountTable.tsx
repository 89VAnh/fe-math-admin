        ...
        <table className='w-full table-auto'>
          <thead>
            <tr className='bg-[#F7F9FC] text-left dark:bg-dark-2'>
              ...
              <th className='min-w-[80px] px-4 py-4 font-medium text-dark dark:text-white text-center'>
                Quyền
              </th>
              ...
              <tr key={index}>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5 ${
                    index === accounts.length - 1 ? "border-b-0" : "border-b"
                  }`}>
                  <Image
                    src={account.avatar}
                    alt={account.name}
                ...
                <td
                  ...
                  <p className='text-dark dark:text-white'>{account.name}</p>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${
                    index === accounts.length - 1 ? "border-b-0" : "border-b"
                  }`}>
                  <p className='text-dark dark:text-white'>{account.email}</p>
                </td>
                ...
                <td
                  ...
                  <p className='text-dark dark:text-white'>{account.phone}</p>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 text-center ${
                    index === accounts.length - 1 ? "border-b-0" : "border-b"
                  }`}>
                  <p
